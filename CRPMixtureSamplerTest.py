...
from CRPMixtureSampler import *

if __name__ == '__main__':

    parser = argparse.ArgumentParser(description='Sampling program for the Chinese Restaurant Process Mixture Model Sampler.')
    ...
    sampler = CRPMixtureSampler(data_file = args.data, 
