...
def run():
    ...
    parser.add_argument('--samplel', default='True', choices=['True', 'False', 'T', 'F'], help='turn on/off the sampling of l')
    parser.add_argument('--samplecategory', default='True', choices=['True', 'False', 'T', 'F'], help='turn on/off the sampling of category')
    ...
    parser.add_argument('--l', default=0.5, type=float, help='l of the coin flipping process')
    ...
    sampler = HGPMixtureSampler(data_file = args.data, 
                                ...
                                sample_l = args.samplel,
                                sample_category = args.samplecategory,
